<template>
  <footer class="bg-white dark:bg-gray-900">
    <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        ...
        <Listbox v-model="locale">
          <div class="-mt-2 relative w-28">
            <ListboxButton
              ...
              <span class="block truncate text-gray-600 dark:text-gray-300">{{ t(locale) }}</span>
            ...
            <transition leave-active-class="transition duration-100 ease-in" leave-from-class="opacity-100"
              ...
              <ListboxOptions
                ...
                <ListboxOption v-slot="{ active, selected }" v-for="item in $i18n.availableLocales"
                  ...
                  <li :class="[
                    active ? 'bg-teal-100 text-teal-900 dark:bg-teal-900 dark:text-teal-100' : 'text-gray-900 dark:text-gray-100',
                    ...
                    <span v-if="selected" class="absolute inset-y-0 left-0 flex items-center pl-3 text-teal-600 dark:text-teal-400">
      ...
      <div class="mt-8 text-center text-base text-gray-400 dark:text-gray-500" v-html="t('copyright')"></div>
    </div>
  </footer>
</template>
